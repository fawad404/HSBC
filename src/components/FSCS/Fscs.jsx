    ...
    return (
        <div className="pt-8 border-t">
            ...
            <p className="text-sm mt-2">
                ...
                <a href="https://www.business.ciiom.hsbc.com/en-gb/regulations/legal-information" className="text-gray-800 hover:text-red-600 underline items-center">
